import 'package:active_speaker_example/meeting/meeting_page.dart';
      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            const Text("Active Speaker example",style: TextStyle(fontSize: 14,fontWeight: FontWeight.w600),)
          ],
        ),
      ),
    );
