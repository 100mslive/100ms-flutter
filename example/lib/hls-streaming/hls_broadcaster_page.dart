...
class _HLSBroadcasterPageState extends State<HLSBroadcasterPage> {
                  ...
                  body: SafeArea(
                    child: Stack(
                      children: [
                            ...
                            builder: (_, data, __) {
                              ...
                              return Selector<MeetingStore,
                                  ...
                                  builder: (_, modeData, __) {
                                    ...
                                    print(
                                        "Size is ${size.toString()} and ratio is ${size.height / size.width}");
                                    return context.read<MeetingStore>().isPipOn
                                        ? pipWidget(context)
                                        : Positioned(
                                            top: 55,
                                            left: 0,
                        ...
                        if (!context.read<MeetingStore>().isPipOn)
                          Column(
                            ...
                            children: [
                              ...
                              Padding(
                                padding: EdgeInsets.only(bottom: (context.read<MeetingStore>().isPipOn ? 0.0 : 8.0)),
                                child: Column(
                                  children: [
  ...
  Widget pipWidget(BuildContext context) {
    MeetingStore _meetingStore = context.read<MeetingStore>();
    Size size = Size(200, 200);
    print("Size is ${size.height / size.width}");
    return GridView(
        gridDelegate:
            SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2),
        children: _meetingStore.peerTracks
            .map((peer) => ChangeNotifierProvider.value(
                key: ValueKey(peer.uid + "video_view"),
                value: peer,
                child: VideoTile(
                  islongPressEnabled: false,
                  key: ValueKey(peer.uid + "audio_view"),
