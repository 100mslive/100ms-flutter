...
that affects <a href="../../hmssdk_flutter/HMSPeer/operator_equals.md">operator ==</a> comparisons.</p>
...
the same way as the default <a href="../../hmssdk_flutter/HMSPeer/operator_equals.md">operator ==</a> implementation only considers objects
...
<p>If <a href="../../hmssdk_flutter/HMSPeer/operator_equals.md">operator ==</a> is overridden to use the object state instead,
...
according to <a href="../../hmssdk_flutter/HMSPeer/operator_equals.md">operator ==</a>.
...
<p>If a subclass overrides <a href="../../hmssdk_flutter/HMSPeer/hashCode.md">hashCode</a>, it should override the
<a href="../../hmssdk_flutter/HMSPeer/operator_equals.md">operator ==</a> operator as well to maintain consistency.</p>
