...
import 'package:hmssdk_uikit/hls_viewer/hls_chat.dart';
import 'package:hmssdk_uikit/hls_viewer/hls_player.dart';
...
class HLSViewerPageLandscape extends StatefulWidget {
  const HLSViewerPageLandscape({
    Key? key,
  }) : super(key: key);
  @override
  State<HLSViewerPageLandscape> createState() => _HLSViewerPageLandscapeState();
}

class _HLSViewerPageLandscapeState extends State<HLSViewerPageLandscape> {
  @override
  void initState() {
    super.initState();
    if (mounted) {
                                                                      ...
                                                                      return AnimatedOpacity(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              SvgPicture.asset(
                                                                                "packages/hmssdk_uikit/lib/assets/icons/red_dot.svg",
                                                                                width: 4,
                                                                                height: 4,
                                                                              ),
                                                                              const SizedBox(
                                                                              ...
                                                                              GestureDetector(
                                                                                  onTap: () => HMSHLSPlayerController.seekToLivePosition(),
                                                                                  child: TitleText(
                                                                                    text: "LIVE",
                                                                              ...
                                                                              GestureDetector(
                                                                                onTap: () => context.read<HLSPlayerStore>().toggleFullScreen(context),
                                                                                child: SvgPicture.asset(
                                                                                  "packages/hmssdk_uikit/lib/assets/icons/${isFullScreen ? "minimize" : "maximize"}.svg",
                                                                                  width: 20,
                                                                                  height: 20,
                                                                                ),
                                                                              ),
