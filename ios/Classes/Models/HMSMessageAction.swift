...
class HMSMessageAction {
    static func messageActions(_ call: FlutterMethodCall, result: @escaping FlutterResult,hmsSDK:HMSSDK?) {
    switch call.method {
    case "send_broadcast_message":
        sendBroadcastMessage(call, result, hmsSDK: hmsSDK)

    case "send_direct_message":
        sendDirectMessage(call, result, hmsSDK: hmsSDK)

    case "send_group_message":
        sendGroupMessage(call, result, hmsSDK: hmsSDK)
    default:
        result(FlutterMethodNotImplemented)
        }
    }
    
    static private func sendBroadcastMessage(_ call: FlutterMethodCall, _ result: @escaping FlutterResult, hmsSDK:HMSSDK?) {
    ...
    static private func sendDirectMessage(_ call: FlutterMethodCall, _ result: @escaping FlutterResult, hmsSDK:HMSSDK?) {
    ...
    static private func sendGroupMessage(_ call: FlutterMethodCall, _ result: @escaping FlutterResult, hmsSDK:HMSSDK?) {
