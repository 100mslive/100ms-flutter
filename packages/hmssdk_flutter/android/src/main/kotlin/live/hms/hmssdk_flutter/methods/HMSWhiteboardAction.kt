...
class HMSWhiteboardAction {
    ...
    companion object{
        ...
        fun whiteboardActions(call: MethodCall, result: Result, hmssdk: HMSSDK,){
            when(call.method){
        ...
        private fun startWhiteboard(call: MethodCall, result: Result, hmssdk: HMSSDK){
        ...
        private fun stopWhiteboard(result: Result, hmssdk: HMSSDK){
