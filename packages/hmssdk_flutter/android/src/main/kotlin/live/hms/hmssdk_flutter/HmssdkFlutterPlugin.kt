...
class HmssdkFlutterPlugin :
    ...
    override fun onMethodCall(
        ...
        when (call.method) {
            ...
            "add_poll_update_listener", "remove_poll_update_listener", "quick_start_poll", "add_single_choice_poll_response", "add_multi_choice_poll_response", "stop_poll", "fetch_leaderboard" -> {
