...
class _PinChatWidgetState extends State<PinChatWidget> {
  ...
  void toggleExpand(BuildContext context, bool showControls) {
  ...
  Widget build(BuildContext context) {
    double pinChatHeight =
        MediaQuery.of(context).size.height * (isExpanded ? 0.2 : 0.1);
              ...
              : Selector<MeetingNavigationVisibilityController, bool>(
                  ...
                  builder: (_, showControls, __) {
                    ...
                    return GestureDetector(
                      onTap: () => toggleExpand(context, showControls),
                      child: Padding(
                        padding: const EdgeInsets.only(bottom: 8.0),
                        child: Row(
                          children: [
                            AnimatedContainer(
                              height: pinChatHeight,
                              width: (HMSRoomLayout
