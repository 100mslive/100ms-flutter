...
class HMSLeftRoomScreen extends StatelessWidget {
  ...
  const HMSLeftRoomScreen({super.key, this.isEndRoomCalled = false});
              ...
              Expanded(
                ...
                children: [
                  ...
                  HMSTitleText(
                    ...
                    text: roomlayout.HMSRoomLayout.peerType ==
                  ...
                  ///If the room is ended and peer role type is hlsViewer, we don't show the button
                  (roomlayout.HMSRoomLayout.peerType ==
                              roomlayout.PeerRoleType.hlsViewer &&
                          isEndRoomCalled)
                      ? const SizedBox()
                                ...
                                Navigator.pushReplacement(
                                    ...
                                    MaterialPageRoute(
                                        builder: (_) => HMSPrebuilt(
                                            roomCode: Constant.meetingUrl,
                                            options:
                                                Constant.prebuiltOptions))),
                              },
                          child: SizedBox(
                            height: 48,
                            width: isEndRoomCalled ? 100 : 91,
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                SvgPicture.asset(
                                ...
                                HMSTitleText(
                                  ...
                                  text: isEndRoomCalled ? "Restart" : "Rejoin",
                                  textColor:
                                      HMSThemeColors.onPrimaryHighEmphasis,
                                )
                              ],
