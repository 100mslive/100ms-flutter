...
///Project imports
import 'package:hms_room_kit/src/preview/grant_permission_screen.dart';
      ...
      child: Selector<MeetingStore, Tuple4<bool, HMSException?, bool, bool>>(
          ...
          builder: (_, failureErrors, __) {
            ...
            return Selector<MeetingStore, bool>(
                selector: (_, meetingStore) => meetingStore.isPermissionGranted,
                builder: (_, isPermissionGranted, __) {
                  return isPermissionGranted
                      ...
                      : Scaffold(
                          body: GrantPermissionScreen(
                          onPermissionRequested: () =>
                              context.read<MeetingStore>().getPermissions(),
                        ));
                });
          }),
    );
