...
class HMSVideoViewWidget(private val context: Context, id: Int, creationParams: Map<String?, Any?>?, private val track: HMSVideoTrack, private val setMirror:Boolean,
                        private val scaleType : Int?,private val matchParent: Boolean? = true,private val isVideoViewListenerAdded:Boolean = false
) : PlatformView {
    ...
    override fun getView(): View {        
        if (hmsVideoView == null) {
            hmsVideoView = HMSVideoView(context, setMirror, scaleType, track,isVideoViewListenerAdded)
        }
        return hmsVideoView!!
    }
...
class HMSVideoViewFactory(private val plugin: HmssdkFlutterPlugin) :
    ...
    override fun create(context: Context?, viewId: Int, args: Any?): PlatformView {
        ...
        val isVideoViewListenerAdded = args["is_video_view_listener_added"] as? Boolean?:false

        return HMSVideoViewWidget(requireNotNull(context), viewId, creationParams, track!!, setMirror!!, scaleType, matchParent,isVideoViewListenerAdded)
    }
}